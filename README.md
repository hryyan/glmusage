...
```bash
# macOS / Linux
curl -sL https://github.com/hryyan/glmusage/releases/latest/download/glmusage-$(uname -s | tr '[:upper:]' '[:lower:]')-$(uname -m) -o glmusage && chmod +x glmusage && sudo mv glmusage /usr/local/bin/
```
